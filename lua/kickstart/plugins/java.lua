-- inspired by https://github.com/mawkler/nvim/blob/master/lua/configs/java.lua
return {
  ...
  config = function()
    ...
    local function jdtls_setup(_)
      ...
      -- This starts a new client and server, or attaches to an existing client
      -- and server depending on the `root_dir`.
